...
def main():
    ...
    # 读取HTML文件内容
    html_file = "output/ai_translate_2026.html"
    ...
    article_title = "2026 AI翻译工具横评 六大工具对比"
    article_author = "AI观察"
    ...
    try:
        ...
        print("\n[Step 2] 使用翻译主题封面图...")
        cover_path = "output/translate_cover.png"
