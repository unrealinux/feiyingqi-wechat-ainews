...
def main():
    ...
    html_file = "output/ai_painting_2026.html"
    ...
    article_title = "2026 AI绘画设计工具横评 六大工具对比"
    article_author = "AI观察"
    ...
    try:
        ...
        print("\n[Step 2] 使用绘画主题封面图...")
        cover_path = "output/painting_cover.png"
