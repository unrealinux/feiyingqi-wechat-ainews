...
def main():
    ...
    html_file = "output/ai_coding_learning_2026.html"
    ...
    article_title = "2026 AI编程学习工具横评 六大工具对比"
    article_author = "AI观察"
    ...
    try:
        ...
        print("\n[Step 2] 使用编程学习主题封面图...")
        cover_path = "output/coding_learning_cover.png"
