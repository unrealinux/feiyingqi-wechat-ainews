...
def main():
    ...
    html_file = "output/ai_data_analysis_2026.html"
    ...
    article_title = "2026 AI数据分析工具横评 六大工具对比"
    article_author = "AI观察"
    ...
    try:
        ...
        print("\n[Step 2] 使用数据分析主题封面图...")
        cover_path = "output/data_analysis_cover.png"
