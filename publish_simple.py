...
def create_draft(token: str, title: str, content: str, author: str = "", digest: str = "") -> str:
    """创建草稿"""
    ...
    article = {
        "title": title,
        "author": author or "AI前沿观察",
        "content": content,
        "digest": digest or "每日AI资讯汇总，带你掌握AI行业最新动态",
        "content_source_url": "",
        "need_open_comment": 0,
